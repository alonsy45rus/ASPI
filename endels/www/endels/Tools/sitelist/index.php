...
foreach ($domains as $dom=>$parts) {
  if (!$prev || !preg_match('/'.preg_quote($prev, '/').'$/si', $dom)) {
    $body=$body."<a href=\"http://{$dom}\"><b>{$dom}</b></a></br>";
    $prev = $dom;
  } else {
    $body=$body."<dd><a href=\"http://{$dom}\">{$dom}</a><br /></dd>";
  }
}
...
$button4="<img border='0' src='../../../../../endels/images/bt4_f.png' width='278' height='45' alt='' class='bt_2' id='Image4' />";
$button5="<a href='../../yourhelp.php' onmouseout=".$kav."MM_swapImgRestore()".$kav."onmouseover=".$kav."MM_swapImage('Image5','','../../../../../endels/images/bt5_f.png',1)".$kav."><img border='0' src='../../../../../endels/images/bt5.png' width='278' height='45' alt='' class='bt_2' id='Image5' /></a>";
