...
<tr><td align='center' style='color:#ffffff; font-size:22px;'><h1>Error 404<h1></td></tr>
</table>
<br><br>
&nbsp&nbspThe requested URL ".$_SERVER['REDIRECT_URL']." was not found on this server.
<br><br>
&nbsp&nbspВы ошиблись при наборе URL в браузере. Вероятнее всего, сервер 
пытается найти файл <tt>".$_SERVER['DOCUMENT_ROOT'].$_SERVER['REDIRECT_URL']."</tt>, 
которого не существует. 
<br><br>
&nbsp&nbspВ случае использования CGI-скриптов, корректные пути к CGI-директориям следующие:<br><br>";
include ("_pathes.php");
