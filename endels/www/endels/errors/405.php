...
<tr><td align='center' style='color:#ffffff; font-size:22px;'><h1>Error 405<h1></td></tr>
</table>
<br><br>
&nbsp&nbspThe requested method POST is not allowed for the URL ".$_SERVER['REDIRECT_URL'].".
<br><br>   
&nbsp&nbspВозможно, вы пытаетесь отправить данные POST-форму на страницу, которая 
...
<br><br>
&nbsp&nbspУчтите, что корректные пути к CGI-директориям следующие: <br><br>";
include ("_pathes.php");
