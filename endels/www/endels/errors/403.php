...
<tr><td align='center' style='color:#ffffff; font-size:22px;'><h1>Error 403<h1></td></tr>
</table>
<br>
...
<br>
&nbsp&nbsp1. Вы пытаетесь запустить CGI-скрипт, расположив его <i>вне</i> CGI-директории 
(например, в директории документов сервера www). Корректные пути к CGI-директориям 
следующие:";
include ("_pathes.php");

$body=$body."
При большом желании вы все же можете запускать скрипты и из www-директории. Для этого 
...
&nbsp&nbsp2. Возможно, вы пытаетесь открыть картинку или статический HTML-файл, расположенный 
...
<br>
&nbsp&nbsp3. Если вы ожидаете получить листинг каталога, но выводится эта ошибка, вероятно, для
